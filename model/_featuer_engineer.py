...
from _data_preprocess import DataPrep
...
class FeatureEng(object):
    ...
    def get_label(self, data):
        ...
        self.ft_cols = list(set(data.columns.tolist()) - set(self.cp_col + self.data_col + self.y_cols))
    ...
    def get_predict_date(self):
        ...
        data = self.merge_data(date=datetime.date().strftime('%Y%m%d'))
